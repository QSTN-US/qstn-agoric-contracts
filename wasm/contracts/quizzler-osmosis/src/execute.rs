...
pub fn create_survey(
    ...
    Ok(Response::new()
        ...
        .add_attribute("amount_funded", amount_sent.to_string())
...
pub fn cancel_survey(
    ...
    let ibc_msg = CosmosMsg::Ibc(helpers::create_ibc_transfer(
        deps.as_ref(),
        env,
...
pub fn set_manager(
    ...
    Ok(Response::new()
        ...
        .add_attribute("manager", manager_addr.to_string())
